...
ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.imageView3).setClipToOutline(true);
    ...
    private void createListViewPaper(){
        ...
        items.add(new Item(R.drawable.thumuagiayphelieu, "Giấy vụn, cạc tông", "5", "Số 245 đường XXX thành phố B",25000, "Lưu ý của người bán: thùng carton to nhỏ khác nhau có hết, thùng đã xài nhiều lần trong nhiều năm."));
    ...
    public void onClickCategoryElectronics(View view) {
